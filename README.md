...
- [x] Explain what a token is used for.
  ...
  - A token is used to authenticate a user and flag them as having appropriate access to protected data.

- [x] What steps can you take in your web apps to keep your data secure?

  - Protected routes that require a tokin are a common way to keep data secure.

- [x] Describe how web servers work.

  - Web servers host data online and allow access to "CRUD" the data with specified endpoints.
